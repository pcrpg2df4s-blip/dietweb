...
async def cmd_start(message: types.Message):
    ...
    # Всегда показываем приветствие с inline кнопками, так как мы не знаем "новый" или нет без доп запроса.
    # Или можно сделать простой SELECT перед вставкой, если критично.
    # Но автор просил просто "сохранять".
    # Давай оставим логику "как для новых" для всех, это безопаснее.
